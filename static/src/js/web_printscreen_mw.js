...
ListView.include({
	...
	export_to_excel: function(export_type) {
            ...
            // Find Header Element
            var header_eles = self.$el.find('.o_list_view > thead')
    ...
    render_pager: function() {
        ...
        this.pager.$el.find("a#button_export_excel").click(function(event){
            self.export_to_excel("excel");
        });

        this.pager.$el.find("a#button_export_pdf").click(function(event){
